...
public class TelephonJoker extends Joker {

	public String[] getTelephonAnswer (Question question) {
		String[] telefonAnswer = new String[1];
		telefonAnswer[0] += "Für die Frage \"" + question.getQuestionText() + "\" denke Ich dass die Antwort: \"";
