...
public class BackEndTesting {
	...
	public void testLoadMainData() {
		...
		File file2= new File("data/highscore.dat");
		file2.delete();
	}
	...
	public void testSaveGameandLoadSaveGame(){
		...
		testing.saveGameToFile("", 50);
		File file = new File("save/game50.wwm");
		// Testing whether the file has been created properly by method saveGameToFile
		assertTrue(file.isFile());
		if(file.exists()) {
			testing.loadQuestionsFromSaveGame(50);
		...
		File file2 = new File("save/game50.wwm");
		file2.delete();
	}
	@Test 
	...
	public void testGenerateTelephoneJoker(){
		...
		assertNotNull(testing.generateTelephoneJokerResults(testing.getQuestionAtIndex(14)));
