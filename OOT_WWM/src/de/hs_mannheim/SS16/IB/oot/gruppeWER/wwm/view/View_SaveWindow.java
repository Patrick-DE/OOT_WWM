...
public class View_SaveWindow extends JPanel implements ActionListener{
	...
	public View_SaveWindow(WWMModel model, String path) {
		...
		btnSpeicherstelle1 = new View_JButton("Speicherstelle 1");
		...
		btnSpeicherstelle2 = new View_JButton("Speicherstelle 2");
		...
		btnSpeicherstelle3 = new View_JButton("Speicherstelle 3");
		...
		btnSpeicherstelle4 = new View_JButton("Speicherstelle 4");
		...
		btnSpeicherstelle5 = new View_JButton("Speicherstelle 5");
		...
		btnSpeicherstelle6 = new View_JButton("Speicherstelle 6");
		...
		btnSpeicherstelle7 = new View_JButton("Speicherstelle 7");
		...
		btnSpeicherstelle8 = new View_JButton("Speicherstelle 8");
